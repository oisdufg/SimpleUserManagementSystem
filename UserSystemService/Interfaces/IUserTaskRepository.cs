...
public interface IUserTaskRepository
{
    ...
    Task<int> CreateAsync(UserTask userTask, CancellationToken cancellationToken);
    Task UpdateAsync(UpdateUserTask userTask, CancellationToken cancellationToken);
